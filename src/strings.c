...
const u8 gText_DefaultNameJohnny[] = _("Johhny");
...
const u8 gText_SizeComparedTo[] = _("Size compered to ");
...
const u8 gText_Tristan[] = _("Tristán");
...
const u8 gText_ThunderPunch48BP[] = _("Thunder punch{CLEAR_TO 0x4E}48BP");
...
ALIGNED(4) const u8 gText_WirelessCommunication[] = _("Wireless Comunication");
...
const u8 gText_MayBrendanMatchCallDesc[] = _("Rad Neighbour");
